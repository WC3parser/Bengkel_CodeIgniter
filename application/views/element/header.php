...
<html lang="en">
  ...
  <body>
      ...
      <a class="navbar-brand" href="https://valconware.com" target="_blank">Huday.com</a>
      ...
      <?php } ?>
         <li class="nav-item dropdown active">
            <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Maintenance</a>
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              <a class="dropdown-item" href="<?php echo site_url('Maintenance')?>">Sistem Perbaikan Mesin</a>
